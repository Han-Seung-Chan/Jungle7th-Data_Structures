...
typedef struct _listㅜode
{
	int item;
	struct _listㅜode *next;
...
void printLinkedList(LinkedList *list)
{
	...
	while (cur != NULL)
	{
		printf("%d ", cur->item); // 여기서 'item'은 노드의 데이터를 저장하는 필드명입니다. 실제 구조체 정의에 따라 다를 수 있습니다.
		cur = cur->next;
	}
	printf("\n");
}
...
void alternateMergeLinkedList(LinkedList *ll1, LinkedList *ll2)
{
	/*
	구현 해야 하는것
	예를 들어 두 개의 링크된 리스트가 LinkedList1과 LinkedList2라고 가정해 보겠습니다:
	LinkedList1: 1, 2, 3
	LinkedList2: 4, 5, 6, 7
	결과 링크된 목록은 다음과 같습니다:
